    ...
    <div id="fp_thumbScroller">
      <div class="container" id="Here">
		...
		foreach ($files as $file) {
			...
			echo "<div class='content'><div><a href='image.php?image=$file' rel='#overlay' id='$file_name-featured'><img src='/newPHP/gallery/thumbs/$file'/></a></div></div>\n";
      ...
      <div class="container">
       <?php
		...
		foreach ($files as $file) {
			...
			$file_name =  basename($file,'.'.$info['extension']);
			if ($file <> "." && $file <> ".." && $file <> "" && !preg_match("/^hide/i",$file))
			echo "<div class='content'><div><a href='slider.php?image=$file' rel='#overlay' id='$file_name-compare'><img src='/newPHP/gallery/before_after/thumbs/$file'/></a></div></div>\n";
