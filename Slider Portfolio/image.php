...
//echo $file_name;
//echo $image;
echo '<div class="main-image"><img src="/code/portfolio/gallery/' . $image . '" width="1170" alt=""></div>';
...
?>
<h3><a href="image.txt">View Image Viewer Source</a></h3>
<div class="toolbar">
...
$(document).ready(function() {
 ...
 function recalculate(current) {
	...
	var last = <? echo $last ?>;
	$(".main-image img").attr("src","/code/portfolio/gallery/"+ current + ".jpg");
	if (next > last) {
		$(".showAfter").hide();
	} else {
		$(".showAfter").show();
