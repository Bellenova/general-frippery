...
?>
<h3><a href="slider.txt">View Slider Source</a></h3>
<div class="toolbar">
...
<div class="slides">
<div class="slide"><img src="/code/portfolio/gallery/before_after/<?PHP echo $file_name ?>_compare.jpg" alt="Compare" width="1170" border="0" usemap="#Map" class="compare" />
  <div class="slide"><img src="/code/portfolio/gallery/before_after/<?PHP echo $file_name ?>_before.jpg" width="1170" alt="Before" class="before-image" /></div>
  <div class="slide"><img src="/code/portfolio/gallery/before_after/<?PHP echo $file_name ?>_after.jpg" width="1170" alt="After" class="after-image" /></div>
...
function showCompare() {
 ...
 function recalculate(current) {
	...
	$(".compare").attr("src","/code/portfolio/gallery/before_after/"+ current + "_compare.jpg").bind('readystatechange load', function(){
		if (this.complete) $(this).fadeIn('fast');
		$(".before-image").attr("src","/code/portfolio/gallery/before_after/"+ current + "_before.jpg");
		$(".after-image").attr("src","/code/portfolio/gallery/before_after/"+ current + "_after.jpg");
	});
  });
	if (next > last) {
		$(".showNext").hide();
