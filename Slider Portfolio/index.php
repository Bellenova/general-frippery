...
<link type="text/css" href="/code/portfolio/css/jquery.ui.theme.css" rel="stylesheet" />
<link type="text/css" href="/code/portfolio/css/jquery.ui.core.css" rel="stylesheet" />
<link type="text/css" href="/code/portfolio/css/jquery.ui.slider.css" rel="stylesheet" />
<link rel="stylesheet" href="/code/portfolio/css/style.css" type="text/css" media="screen"/>
<script type="text/javascript" src="/code/portfolio/js/jquery.js"></script>
<script src="/code/portfolio/js/jquery.tools.min.js"></script>
<script type="text/javascript" src="/code/portfolio/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="/code/portfolio/js/jquery.easing.1.3.js"></script>
</head>
<body>

<!-- overlayed element -->
<h3><a href="index.txt">View Index Source</a></h3>
<div class="apple_overlay" id="overlay">
  <div class="contentWrap"></div>
</div>
<div class="gallery-container" style="clear: both; height: 100%; width: 100%; min-height: 700px; ">
<div id="fp_gallery" class="fp_gallery">
  <ul id="fp_galleryList" class="fp_galleryList">
    <li id="openGallery">Featured Designs</li>
    <li id="beforeAfter">Before and After dsa</li>
  </ul>
  <div class="instructions"> Please select an image gallery above, and click on an image to enlarge.</div>
  <div id="fp_thumbContainer">
    <div id="fp_thumbScroller">
      <div class="container" id="Here">
        <?php
		$current_dir = "gallery/thumbs";   
		...
		foreach ($files as $file) {
			...
			if ($file <> "." && $file <> ".." && $file <> "" && !preg_match("/^hide/i",$file))
			echo "<div class='content'><div><a href='image.php?image=$file' rel='#overlay' id='$file_name-featured'><img src='/code/portfolio/gallery/thumbs/$file'/></a></div></div>\n";
      ...
      <div class="container">
       <?php
		$current_dir = "gallery/before_after/thumbs";   
		$dir = opendir($current_dir);     
		$files = array();
		while ($files[] = readdir($dir));
		sort($files);
		...
		foreach ($files as $file) {
			...
			$file_name =  basename($file,'.'.$info['extension']);
			if ($file <> "." && $file <> ".." && $file <> "" && !preg_match("/^hide/i",$file))
			echo "<div class='content'><div><a href='slider.php?image=$file' rel='#overlay' id='$file_name-compare'><img src='/code/portfolio/gallery/before_after/thumbs/$file'/></a></div></div>\n";
  ...
  <div id="fp_next" class="fp_next">NEXT</div>
  <div id="fp_prev" class="fp_prev">PREV</div>
</div>
</div>
<!--  JAVASCRIPT --> 
		...
		onBeforeLoad: function() {
			...
			$(function() {
				...
				//	alert('gallery triggered'); 
					...
					//and show this one
					//alert($fp_content_wrapper.attr('id'));
					...
					*/
					...
					$fp_thumbContainer.animate({'height':'415px'},200,function(){
